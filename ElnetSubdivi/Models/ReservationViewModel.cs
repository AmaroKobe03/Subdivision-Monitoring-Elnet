...
namespace ElnetSubdivi.ViewModels
{
    public class ReservationViewModel
    {
        ...
        public DateTime TimeIn { get; set; } = DateTime.Now.AddHours(1).Date + TimeSpan.FromHours(9); // Default to 9:00 AM

        [Required(ErrorMessage = "End time is required")]
        [Display(Name = "End Time")]
        [DataType(DataType.Time)]
        [CustomValidation(typeof(ReservationViewModel), "ValidateTimeOut")]
        public DateTime TimeOut { get; set; } = DateTime.Now.AddHours(1).Date + TimeSpan.FromHours(17); // Default to 5:00 PM
        ...
        public static ValidationResult ValidateTimeOut(DateTime timeOut, ValidationContext context)
        {
